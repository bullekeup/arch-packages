...
pkgbase=opencv
pkgname=('opencv-gstreamer' 'opencv-gstreamer-samples')
pkgver=3.1.0
pkgrel=3
...
license=('BSD')
url="http://opencv.org/"
depends=('intel-tbb' 'openexr' 'xine-lib' 'libdc1394' 'gtkglext' 'gstreamer' 'gst-libav' 'ffmpeg' 'libx264' 'x264' 'gdal' 'libgphoto2')
